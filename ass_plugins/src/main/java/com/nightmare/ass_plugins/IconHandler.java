...
//        String url = session.getUri();
    ...
    public synchronized Bitmap getBitmap(String packageName, boolean useDesperateWay) {
        ...
        try {
            ...
            //        at com.nightmare.ass_plugins.IconHandler.getBitmap(IconHandler.java:107)
            //        at com.nightmare.ass_plugins.IconHandler.getBitmap(IconHandler.java:83)
            //        at com.nightmare.ass_plugins.IconHandler.handle(IconHandler.java:59)
