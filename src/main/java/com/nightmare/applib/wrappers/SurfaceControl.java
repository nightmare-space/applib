...
public final class SurfaceControl {
    ...
    static Method setBootDisplayModeMethod;

    public static void setBootDisplayMode(IBinder displayToken, int displayModeId) throws Exception {
        if (setBootDisplayModeMethod == null) {
            setBootDisplayModeMethod = CLASS.getMethod("setBootDisplayMode", IBinder.class, int.class);
        }
        setBootDisplayModeMethod.invoke(null, displayToken, displayModeId);
    }
...
//    }
    ...
    public static Object getDynamicDisplayInfo(long displayId) throws Exception {
        Method getDynamicDisplayInfoMethod = CLASS.getMethod("getDynamicDisplayInfo", long.class);
        return getDynamicDisplayInfoMethod.invoke(null, displayId);
    }
}
